...
export default function SplashScreen({ onComplete }: SplashScreenProps) {
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center card-3d">
      <div
        className="card-inner bg-gradient-to-b from-brown-dark via-red-dark to-burgundy flex flex-col justify-center items-center p-8 relative overflow-hidden rounded-lg cursor-pointer"
        style={{
          width: '360px',
          height: '640px',
